...
class CreditsState extends MusicBeatState
{
    ...
    var sectionArrays:Array<Dynamic> = [
		...
		[
			...
			['TSG', '@AyeTSG', 'tsg', FlxColor.fromRGB(120, 120, 120), 'https://twitter.com/ayetsg', ['bark bark im programming', 'hi aether', 'hi jaden', 'i love tally hall', 'i do a little trolling', 'dame da ne', 'bark', 'axolotls are cool', 'i like cats', 'i like fennec foxes', 'follow @aetherdx on twitter', 'follow @fennykinz on twitter']]
		],
		[
			// Charting
