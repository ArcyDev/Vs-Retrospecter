...
class ModchartState
{
    ...
    function new()
    {
				...
				if (PlayState.trueEctospasm)
					path = Paths.lua(songLowercase + "/modchart-truehell");
				else if (PlayState.isSM)
					path = PlayState.pathToSm + "/modchart.lua";
				else
					path = Paths.lua(songLowercase + "/modchart");
